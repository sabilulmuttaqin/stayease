...
@section('content')
    ...
    <div id="TopNav" class="relative flex items-center justify-between px-5 mt-[60px]">
        ...
        <p class="font-semibold">Checkout stayease</p>
    ...
    <div
        ...
        <div class="flex flex-col gap-4 pt-[22px]">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <img src="{{ asset('assets/images/icons/location.svg') }}" class="w-6 h-6 flex shrink-0"
                        alt="icon">
                    <p class="text-ngekos-grey">{{ $boardingHouse->name }} Location</p>
                </div>
                <p class="font-semibold">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <p class="text-ngekos-grey">Tunjukkan kode ini kepada resepsionis {{ $boardingHouse->name }} sebagai
                        bukti transaksi</p>
                </div>
    ...
    <form action="{{ route('booking.payment', $boardingHouse->slug) }}" method="POST"
        class="relative flex flex-col gap-6 mt-5 pt-5">
        @csrf
