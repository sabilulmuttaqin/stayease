        ...
        <form action="{{ route('show-booking') }}" method="POST"
            ...
            <div id="InputContainer" class="flex flex-col gap-[18px]">
                <div class="flex flex-col w-full gap-2">
                    ...
                    <label
                        class="flex items-center w-full rounded-full p-[14px_20px] gap-3 @error('code') border-red-500 @enderror bg-white ring-1 ring-[#F1F2F6] focus-within:ring-[#91BF77] transition-all duration-300">
                ...
                <div class="flex flex-col w-full gap-2">
                    ...
                    <label
                        class="flex items-center w-full rounded-full p-[14px_20px] @error('email') border-red-500 @enderror gap-3 bg-white ring-1 ring-[#F1F2F6] focus-within:ring-[#91BF77] transition-all duration-300">
                ...
                <div class="flex flex-col w-full gap-2">
                    ...
                    <label
                        class="flex items-center w-full rounded-full @error('phone_number') border-red-500 @enderror  p-[14px_20px] gap-3 bg-white ring-1 ring-[#F1F2F6] focus-within:ring-[#91BF77] transition-all duration-300">
