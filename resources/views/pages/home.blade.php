...
@section('content')
    ...
    <div id="TopNav" class="relative flex items-center justify-between px-5 mt-[60px]">
        <div class="flex flex-col gap-1">
            <p>Good day,</p>
            <h1 class="font-bold text-xl leading-[30px]">Explore StayEase</h1>
        </div>
    ...
    <div id="Categories" class="swiper w-full overflow-x-hidden mt-[30px]">
                    ...
                    <a href="{{ route('category.show', $category->slug) }}" class="card">
                        <div
                            ...
                            <div class="flex flex-col gap-[2px]">
                                ...
                                <p class="text-sm text-ngekos-grey">{{ $category->boarding_houses->count() }}
                                    {{ $category->name }}</p>
                            </div>
                        </div>
                    </a>
                ...
                <div class="swiper-wrapper">
                    @foreach ($popularBoardingHouse as $popular)
                        <div class="swiper-slide !w-fit">
                            <a href="{{ route('boarding-house.show', $popular->slug) }}" class="card">
                                <div
                                    ...
                                    <div class="flex flex-col gap-3">
                                        ...
                                        <div class="flex items-center gap-[6px]">
                                            ...
                                            <p class="text-sm text-ngekos-grey">{{ $popular->city->name }} City</p>
                                        </div>
                                        <div class="flex items-center gap-[6px]">
                                        ...
                                        <div class="flex items-center gap-[6px]">
                                            ...
                                            <p class="text-sm text-ngekos-grey">
                                                {{ $popular->rooms->first()->capacity }} People</p>
                                        </div>
                                        <div class="flex items-center gap-[6px]">
                                            <img src="{{ asset('assets/images/icons/profile-2user.svg') }}"
                                                class="w-5 h-5 flex shrink-0" alt="icon">
                                            <p class="text-sm text-ngekos-grey">{{ $popular->address }}
                                            </p>
                                        </div>
                                        <hr class="border-[#F1F2F6]">
                                        <p class="font-semibold text-lg text-ngekos-orange">Rp
                                            {{ number_format($popular->price, 0, ',', '.') }}<span
                    ...
                    <a href="{{ route('city.show', $city->slug) }}" class="card">
                        <div
                            ...
                            <div class="flex flex-col gap-[2px]">
                                ...
                                <p class="text-sm text-ngekos-grey">{{ $city->boarding_houses->count() }} Kos</p>
                            </div>
                        </div>
                    </a>
                @endforeach
        ...
        <section id="Best" class="flex flex-col gap-4 px-5 mt-[30px]">
            <div class="flex items-center justify-between">
                <h2 class="font-bold">All Great stayease</h2>
                <a href="#">
                    <div class="flex items-center gap-2">
                        <span>See all</span>
                        <img src="{{ asset('assets/images/icons/arrow-right.svg') }}" class="w-6 h-6 flex shrink-0"
                        ...
                        <div
                            ...
                            <div class="flex flex-col gap-3 w-full">
                                ...
                                <div class="flex items-center gap-[6px]">
                                    <img src="{{ asset('assets/images/icons/profile-2user.svg') }}"
                                        class="w-5 h-5 flex shrink-0" alt="icon">
                                    <p class="text-sm text-ngekos-grey">{{ $boardingHouse->rooms->first()->capacity }}
                                        People</p>
                                </div>
                                <div class="flex items-center gap-[6px]">
                                    <img src="{{ asset('assets/images/icons/profile-2user.svg') }}"
                                        class="w-5 h-5 flex shrink-0" alt="icon">
                                    <p class="text-sm text-ngekos-grey">{{ $boardingHouse->address }}
                                    </p>
                                </div>
                                <hr class="border-[#F1F2F6]">
                                <p class="font-semibold text-lg text-ngekos-orange">Rp
