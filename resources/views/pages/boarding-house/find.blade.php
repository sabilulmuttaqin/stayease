...
@section('content')
    ...
    <div class="relative flex flex-col gap-[30px] my-[60px] px-5">
        <h1 class="font-bold text-[30px] leading-[45px] text-center">Explore Our<br>Beautiful stayease</h1>
        <form action="{{ route('find-booking.result') }}"
                ...
                <div class="flex flex-col w-full gap-2">
                    ...
                    <label
                        ...
                        <input type="text" name="search" id=""
                            ...
                            placeholder="Type the stayease name">
                    </label>
                </div>
                <div class="flex flex-col w-full gap-2">
